 ...
 */
package com.riphtix.mem.server.entity;
...
import com.riphtix.mem.server.entity.ai.DragonBodyHelper;
import com.riphtix.mem.server.entity.breeds.DragonBreed;
import com.riphtix.mem.server.entity.helper.*;
...
public class EntityTameableDragon extends EntityFlyingTameable {
    ...
    protected void playStepSound(BlockPos entityPos, Block block) {
        if (isEgg() || inWater) {
            ...
            worldObj.playSoundAtEntity(this, Reference.MOD_ID + ":mob.enderdragon.step", 0.5f, 1);
        }
    }
