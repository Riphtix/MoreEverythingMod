package com.riphtix.mem.client.model;

import com.riphtix.mem.Reference;
import com.riphtix.mem.client.model.anim.DragonAnimator;
...
public class DragonModel extends ModelBase {
	...
	public DragonModel(DragonBreed breed) {
		...
		bodyTexture = new ResourceLocation(Reference.MOD_ID, DragonRenderer.TEX_BASE + breed.getSkin() + "/body.png");
		glowTexture = new ResourceLocation(Reference.MOD_ID, DragonRenderer.TEX_BASE + breed.getSkin() + "/glow.png");
		saddleTexture = new ResourceLocation(Reference.MOD_ID, DragonRenderer.TEX_BASE + breed.getSkin() + "/saddle.png");
		eggTexture = new ResourceLocation(Reference.MOD_ID, DragonRenderer.TEX_BASE + breed.getSkin() + "/egg.png");
