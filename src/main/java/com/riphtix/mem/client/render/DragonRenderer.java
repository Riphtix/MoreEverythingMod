...
import com.riphtix.mem.client.forgeobjmodelported.AdvancedModelLoader;
...
import com.riphtix.mem.server.entity.helper.DragonBreedRegistry;
import com.riphtix.mem.server.entity.helper.DragonLifeStageHelper;
...
public class DragonRenderer extends RenderLiving {
	...
	private final ResourceLocation dissolveTextureLoc = new ResourceLocation(Reference.MOD_ID, TEX_BASE + "dissolve.png");
	private final ResourceLocation eggModelLoc = new ResourceLocation(Reference.MOD_ID, MDL_BASE + "dragon_egg.obj");
