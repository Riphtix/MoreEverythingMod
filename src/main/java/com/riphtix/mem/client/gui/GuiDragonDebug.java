 ...
 */
package com.riphtix.mem.client.gui;
...
import com.riphtix.mem.server.entity.helper.DragonBreedHelper;
import com.riphtix.mem.server.entity.helper.DragonLifeStageHelper;
import com.riphtix.mem.server.entity.helper.DragonReproductionHelper;
...
public class GuiDragonDebug extends Gui {
    ...
    private void renderTitle() {
        String title = String.format("%s %s Debug", Reference.MOD_NAME,
                MoreEverythingMod.instance.getMetadata().version);
